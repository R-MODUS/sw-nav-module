...
from rmodus_brain.webbridge.sensor_catalog import SensorDefinition
from rmodus_brain.webbridge.tf_utils import quaternion_to_yaw
...
class WebBridgeNode(Node):
    ...
    def _create_tf_subscriptions(self):
        ...
        self.create_subscription(
            TFMessage,
            "/tf_static",
            lambda msg: self.tf_callback(msg, is_static=True),
            tf_static_qos,
        )
    ...
    def publish_tf_snapshot(self):
        ...
        message = {
            ...
            "frames": self.get_tf_frames_snapshot(),
        }
        self._broadcast_threadsafe(message)
