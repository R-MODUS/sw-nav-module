...
def generate_launch_description():
    bringup_dir = get_package_share_directory("rmodus_autonomy")
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            ...
            Node(
                ...
                arguments=["--ros-args", "--log-level", log_level, "--log-level", "controller_server:=warn"],
            ...
            Node(
                ...
                respawn_delay=2.0,
                parameters=[configured_params],
                arguments=["--ros-args", "--log-level", log_level, "--log-level", "planner_server:=warn"],
                remappings=remappings,
            ),
            Node(
