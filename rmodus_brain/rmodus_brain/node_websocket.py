...
try:
    ...
    _PISTATUS_AVAILABLE = True
except ImportError:
    PiStatus = None
    _PISTATUS_AVAILABLE = False
    print("Warning: Could not import PiStatus message. /system/pi_status subscription disabled.")
